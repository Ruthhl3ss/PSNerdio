function Get-NerdioMEHostpool {
  <#
  .SYNOPSIS
    Retrieves details of a specific Nerdio Managed Environment (NME) host pool.
  .DESCRIPTION
    The Get-NerdioMEHostpool cmdlet fetches information about a specified host pool within a Nerdio Managed Environment (NME).
  ...
  .EXAMPLES
    Get-NerdioMEHostpool -Name "MyHostPool" -ResourceGroupName "MyResourceGroup" -SubscriptionId "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
    Retrieves details of the host pool named "MyHostPool" in the specified resource group and subscription.
  .NOTES
    Author: Niels Kok
    Date: September 2025
  #>
